...
public class UserDaoJdbcImpl implements UserDao {
    ...
    public int insertOne(User user) throws DataAccessException {
        ...
        int rowNumber = jdbc.update("insert into m_user (user_id,password,user_name,role)values(?,?,?,?)",
                user.getUserId(), user.getPassword(), user.getUserName(), user.getRole());
        return rowNumber;
    }
    ...
    public int updateOne(User user) throws DataAccessException {
        ...
        int rowNumber = jdbc.update("update m_user set password = ?, user_name = ? where user_id = ?",
                user.getPassword(), user.getUserName(), user.getUserId());
        return rowNumber;
    }
